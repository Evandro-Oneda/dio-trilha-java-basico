...
public class Problem {
    public static void main(String[] args) {
    	...
    	for (int i = 0; i < N; i++) {
    		...
    		else if (jogador2.equalsIgnoreCase("ataque")&& jogador2.equalsIgnoreCase("papel")) System.out.println( "Jogador 1 venceu");
    		else if (jogador2.equalsIgnoreCase("papel") && jogador2.equalsIgnoreCase("pedra")) System.out.println( "Jogador 2 venceu");
